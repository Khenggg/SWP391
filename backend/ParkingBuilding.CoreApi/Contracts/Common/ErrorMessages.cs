...
public static class ErrorMessages
{
    private static readonly Dictionary<string, string> Messages = new()
    {
        ...
        [ErrorCodes.InvalidUserRole] = "Vai trò người dùng được chọn không hợp lệ.",
        [ErrorCodes.InvalidUserStatus] = "Trạng thái người dùng được chọn không hợp lệ.",
        [ErrorCodes.ReasonRequired] = "Vui lòng nhập lý do thay đổi.",
        [ErrorCodes.CannotChangeOwnStatus] = "Bạn không thể tự khóa hoặc vô hiệu hóa tài khoản của chính mình.",
        [ErrorCodes.CannotDisableLastAdmin] = "Không thể khóa tài khoản Admin hoạt động cuối cùng.",
        [ErrorCodes.CannotChangeOwnRole] = "Bạn không thể tự hạ cấp vai trò Admin của chính mình.",
        [ErrorCodes.CannotDemoteLastAdmin] = "Không thể hạ cấp vai trò của tài khoản Admin cuối cùng.",
        ...
        [ErrorCodes.CardIsMonthlyCannotUseAsCasual] = "Thẻ đã từng gán vé tháng không được dùng làm thẻ vãng lai.",
        ...
        [ErrorCodes.MonthlyPassLocked] = "Thẻ đang bị khóa.",
        ...
        [ErrorCodes.SnapshotNotFound] = "Khong tim thay anh snapshot da tai len.",
        [ErrorCodes.SnapshotTypeInvalid] = "Loai anh snapshot khong hop le.",
        [ErrorCodes.SnapshotSessionRequired] = "Anh xe ra phai gan voi mot phien gui xe dang hoat dong.",
        [ErrorCodes.SnapshotSessionMismatch] = "Anh snapshot khong thuoc phien gui xe nay.",
        [ErrorCodes.SnapshotOwnershipInvalid] = "Ban khong co quyen su dung anh snapshot nay.",
        [ErrorCodes.SnapshotExpired] = "Anh snapshot da het han.",
        [ErrorCodes.SnapshotStatusInvalid] = "Trang thai anh snapshot khong cho phep su dung.",
