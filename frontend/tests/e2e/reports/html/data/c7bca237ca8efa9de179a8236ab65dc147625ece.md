...
- Name: p1\public-pages.spec.ts >> Public Pages Acceptance Suite >> Available Slots >> 4.5 Combined Filters - multiple filters applied
...
Call log:
  ...
  - waiting for getByText('F2-CAR-01')
