...
- Name: p1\public-pages.spec.ts >> Public Pages Acceptance Suite >> Available Slots >> 4.1 Default Slot Loading - verify list appears
- Location: tests\e2e\specs\p1\public-pages.spec.ts:175:5
...
Locator: getByText('DEFAULT-A-01')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('DEFAULT-A-01')
