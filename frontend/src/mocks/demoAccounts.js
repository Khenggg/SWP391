// Danh sách các tài khoản chạy thử (Demo) phục vụ cho chức năng đăng nhập nhanh ở trang Login
export const DEMO_ACCOUNTS = [
  ...
  { label: "Tài xế Vãng lai", username: "visitor01", color: "from-slate-500/20 to-zinc-500/20 text-slate-300 border-slate-500/30" },
