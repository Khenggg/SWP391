...
- Name: tests\e2e\specs\p1\public-pages.spec.ts >> Public Pages Acceptance Suite >> Pricing >> verify pricing table renders correctly
...
Call log:
  - navigating to "/pricing", waiting until "load"
