...
- Name: tests\e2e\specs\p1\public-pages.spec.ts >> Public Pages Acceptance Suite >> Available Slots >> 4.4 Floor Filter - list updates
...
Call log:
  - navigating to "/slots?floorId=1", waiting until "load"
