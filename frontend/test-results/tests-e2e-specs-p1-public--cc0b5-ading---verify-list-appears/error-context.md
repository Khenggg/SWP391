...
- Name: tests\e2e\specs\p1\public-pages.spec.ts >> Public Pages Acceptance Suite >> Available Slots >> 4.1 Default Slot Loading - verify list appears
...
Call log:
  - navigating to "/slots", waiting until "load"
