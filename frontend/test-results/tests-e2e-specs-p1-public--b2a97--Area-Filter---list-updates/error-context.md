...
- Name: tests\e2e\specs\p1\public-pages.spec.ts >> Public Pages Acceptance Suite >> Available Slots >> 4.3 Area Filter - list updates
...
Call log:
  - navigating to "/slots?areaId=1", waiting until "load"
